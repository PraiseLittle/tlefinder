...
def test_simple_search_maps_tle_age_limit_to_core_request():
    from tlefinder.api.adapters import simple_search_to_core_request
    from tlefinder.core.models import TleAgeLimit

    default_request = simple_search_to_core_request(simple_search_request())
    week_request = simple_search_to_core_request(
        simple_search_request(tle_age_limit="1w")
    )

    assert default_request.tle_age_limit is TleAgeLimit.HOURS_24
    assert week_request.tle_age_limit is TleAgeLimit.WEEK_1
...
def test_advanced_search_maps_tle_age_limit_to_core_request():
    from tlefinder.api.adapters import advanced_search_to_core_request
    from tlefinder.core.models import TleAgeLimit

    default_request = advanced_search_to_core_request(advanced_search_request())
    week_request = advanced_search_to_core_request(
        advanced_search_request(tle_age_limit="1w")
    )
